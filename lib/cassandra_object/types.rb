module CassandraObject
  module IntegerType
    ...
    def encode(int)
      return '' if int.nil?
      raise ArgumentError.new("#{self} requires an Integer or a String that looks like a Integer. You passed #{int.inspect}") unless int.kind_of?(Integer) || int.match(REGEX)
      int.to_s
    end
